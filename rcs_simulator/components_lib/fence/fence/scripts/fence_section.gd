...
func edit_grid():
	var edited_grid = get_grid()
	edited_grid.scale.x =(((section_height-55) - (floor_gap+30))/1890.0)*945
	edited_grid.translation.y = ((section_height-55) - (floor_gap+30))/2.0 + floor_gap + 30
	edited_grid.scale.z = ((section_width - 170)/1250.0)*625
	edited_grid.translation.z = (section_width - 170)/2.0 + 90
#-------->SETTERS<-----------------------------------------------
