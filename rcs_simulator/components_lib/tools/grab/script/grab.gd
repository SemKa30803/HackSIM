...
func set_lifted(value):
	...
	var arm_2 = get_node_or_null("grab/RcsToggleJoint/fingers2") as MeshInstance
	if arm_2:
...
func set_width_of_tip(value):
	...
	var width_grid2 = get_node_or_null("grab/RcsToggleJoint/fingers2/grip23") as MeshInstance
	if width_grid2:
		width_grid2.scale.z = width_tip_of_arms_mm/10
	var arm_1_width = get_node_or_null("grab/RcsToggleJoint/fingers1") as MeshInstance
	var arm_2_width = get_node_or_null("grab/RcsToggleJoint/fingers2") as MeshInstance
...
func set_width(value):
	...
	var width_grid23 = get_node_or_null("grab/RcsToggleJoint/fingers2/grip23") as MeshInstance
	if width_grid23:
	...
	var width_grip22 = get_node_or_null("grab/RcsToggleJoint/fingers2/grip22") as MeshInstance
	if width_grip22:
